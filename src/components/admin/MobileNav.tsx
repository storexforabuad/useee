...
const navItems = [
  ...
  { id: 'store', iconOutline: EyeIconOutline, iconSolid: EyeIconSolid, label: 'Store' },
              ...
              return (
                <div key={item.id} className="relative w-16 h-16">
                  ...
                  <button
                    ...
                    className="absolute -top-7 left-1/2 -translate-x-1/2 w-16 h-16 bg-purple-600 rounded-full shadow-lg flex items-center justify-center text-white focus:outline-none focus:ring-2 focus:ring-offset-4 focus:ring-offset-background dark:focus:ring-offset-zinc-800 focus:ring-purple-500 transition-transform duration-200 ease-in-out hover:scale-105 active:scale-95"
