...
const StoreLinkModal: React.FC<StoreLinkModalProps> = ({ storeLink, handleClose }) => {
  ...
  const shareMessage =
    '🌟 Discover authentic fashion at the new Arewa Mode Online Store! 🛒 Enjoy exclusive discounts 🎉 A beautiful selection of fabrics & Materias ✨ Nationwide delivery 🚚 🇳🇬. Shop now: https://tinyurl.com/arewamode1';
  ...
  const socialPlatforms = [
    { name: 'WhatsApp', icon: WhatsAppIcon, url: `https://wa.me/?text=${encodeURIComponent('🌟 Discover authentic fashion at the new Arewa Mode Online Store! 🛒 Enjoy exclusive discounts 🎉 A beautiful selection of fabrics & Materias ✨ Nationwide delivery 🚚 🇳🇬. Shop now: https://tinyurl.com/arewamode1')}`, color: 'hover:text-[#25D366]' },
